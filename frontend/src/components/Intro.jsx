        ...
        <div className="bg-[#D9D9D9]">
            <div className="mx-auto max-w-[1350px] w-full relative h-[100vh]">
                <div className="flex justify-between  pt-[300px]">
                    <div>
                        <div>
                            <h1 className="text-[82px] font-bold slide-up">Ваша техника.</h1>
                            <h1 className="text-[82px] font-bold slide-up slide-up-delay-1">Ваш стиль.</h1>
                            <h1 className="text-[82px] font-bold slide-up slide-up-delay-2">Ваша Apple.</h1>
                        </div>
                    ...
                    <div className="absolute bottom-[0] right-[0] w-full max-w-[440px]">
