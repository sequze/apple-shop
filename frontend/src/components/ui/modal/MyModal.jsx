...
const MyModal = ({children, visible, setVisible}) => {
    ...
    return (
        <div
            role="dialog"
            aria-modal="true"
            className={`transform fixed z-[200] bg-opacity-80 top-0 left-0 w-full h-full bg-[#000] flex flex-col items-center justify-center transition-all duration-300
            ${visible ? 'opacity-100 pointer-events-auto scale-100' : 'opacity-0 pointer-events-none scale-95'}`
